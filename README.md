...
| 15 | En tant qu'utilisateur identifié, je souhaite pouvoir créer un test "End to End" et le lier à une issue en entrant le nom (obligatoire), la description (optionnelle), l'id de l'issue (obligatoire) et un état (obligatoire) afin de permettre le suivi de la réalisation de cette tâche. | LOW | 3 | 3 |
